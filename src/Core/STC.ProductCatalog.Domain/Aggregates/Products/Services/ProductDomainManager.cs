...
{
    public async ValueTask<Product> CreateAsync(string name, string description, string imageUrl, long price,
        CancellationToken cancellationToken)
    {
        ...
        return Product.Create(name: name, description: description, imageUrl: imageUrl, price: price);
    }
